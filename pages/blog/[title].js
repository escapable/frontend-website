...
// PrismJS (https://prismjs.com/) is imported to help with syntax 
// highlighting in  code snippets that might be used in blog posts 
    ...
    render () {
        return (
            <div className="layout-wrapper">
                <HeadMetadata 
                    title={this.props.post ? this.props.post.seoTitleTag : "Blog Post | escpabale.space blog"}
